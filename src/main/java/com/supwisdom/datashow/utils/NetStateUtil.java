...
public class NetStateUtil {
 ...
      */
    ...
    public static void main(String[] args) {
        ...
        String url1 = "https://www.baidu.com";//测试https
        String url2 = "http://118.25.69.252";//测试http
        String url3 = "192.168.55.56";//测试普通ip
        ...
        System.out.println(DateUtil.getTermDate());
    }
}
